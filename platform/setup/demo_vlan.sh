            ...
            for ((i = 0; i < n_routers; i++)); do
                ...
                if [[ "$rname" == "l1-1" ]]; then
                    ...
                    # OSPF area 2
                    {
                        ...
                        # l2 OSPF
                        echo "network $(subnet_l2 ${group_number} 0 20 1) area 2"
                ...
                if [[ "$rname" == "l1-2" ]]; then
                    ...
                    docker exec "${group_number}_${rname}router" ip tunnel add gre1 mode gre remote 66.0.34.2 local 66.0.1.2 ttl 255
                    ...
                    docker exec "${group_number}_${rname}router" ip route add 66.101.0.1/32 dev gre1
                    docker exec "${group_number}_${rname}router" ip route add 66.101.1.1/32 dev gre1
                    docker exec "${group_number}_${rname}router" ip route add 66.101.2.1/32 dev gre1
                    docker exec "${group_number}_${rname}router" ip route add 66.101.3.1/32 dev gre1
                    docker exec "${group_number}_${rname}router" ip route add 66.101.4.1/32 dev gre1
                    docker exec "${group_number}_${rname}router" ip route add 66.101.5.1/32 dev gre1
                ...
                if [[ "$rname" == "dcn1-1" ]]; then
                    ...
                    # OSPF area 1
                    {
                        ...
                        # l2 OSPF
                        echo "network $(subnet_l2 ${group_number} 1 10 1) area 1"
                ...
                if [[ "$rname" == "l2-1" ]]; then
                    ...
                    docker exec "${group_number}_${rname}router" ip tunnel add gre1 mode gre remote 66.0.1.2 local 66.0.34.2 ttl 255
                ...
                if [[ "$rname" == "bb2-2" ]]; then
                    # OSPF area 3
                    {
                        ...
                        # l2 OSPF
                        echo "network $(subnet_l2 ${group_number} 2 30 1) area 3"
